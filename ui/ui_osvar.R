  ...
  fluidPage(
    fluidRow(
      ...
      column(6, align = 'right',
        ...
        actionButton(inputId='osvarlink2', label="Tutorial", icon = icon("university"),
          onclick ="window.open('https://rsquaredacademy.github.io/inferr-book/one-sample-variance-test.html', '_blank')"),
